<template>
          <div class="order-content">
            ...
            <div class="orders">
              ...
              <table class="order-item" v-for="item in payList.records" :key="item.id">
                <thead>
                  <tr>
                    <th colspan="5">
                  ...
                  <tr v-for="item2,index in item.orderDetailList" :key="item2.id">
                    <td width="60%" >
                      <div class="typographic">
                        <img :src="item2.imgUrl" style="width: 80px;height: 80px;">
            ...
            <div class="choose-order">
              <div class="pagination">
                <ul>
                  ...
                  <li class="page" :class="{actived:index==currentIndex}" v-for="item,index in payList.pages" :key="index" @click="pageChange(index)">
                    <a>{{item}}</a>
                  </li>
...
mounted(){
  console.log(222);
    this.$API.getPayList(this.page,this.limit).then((result)=>{
